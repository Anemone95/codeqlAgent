...
export PATH=$CODEQL_JAVA_HOME/bin:$PATH

jvm_args="-Xss16m -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5005"
jvm_args="-Xss16m"
...
env SEMMLE_DIST="$CODEQL_EXTRACTOR_JAVASCRIPT_ROOT" \
    ...
    -javaagent:/Users/wenyuan/Work/cispa/bundle/codeqlagent/target/codeqlagent-1.0-SNAPSHOT.jar \
